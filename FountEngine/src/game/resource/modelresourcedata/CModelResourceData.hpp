...
#include "../modelbufferinfo/CModelBufferInfo.hpp"
...
public:
	...
	CModelResourceData(std::vector<Vertex_t> vecVertices, std::vector<uint32_t> vecIndices) 
		: m_vecModelVertices(std::move(vecVertices)), m_vecModelIndices(std::move(vecIndices)), m_ModelBufferInfo(0) { }
	...
	CModelBufferInfo* GetModelBufferInfo() { return &m_ModelBufferInfo; }
